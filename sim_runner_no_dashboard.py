...
def construct_use_case_library(gen_config: Dict, control_config: Dict) -> Dict:
...
if __name__ == "__main__":
    ...
    while ts < simulation_duration:
        ...
        SoC_temp = new_SoC
        print(str(current_time) + "-->" + " Current Active Power Battery Setpoint: " + str(
            battery_obj.battery_setpoints_actual[ts]))
        print(str(current_time) + "-->" + " Current Battery SoC: " + str(battery_obj.SoC_actual[ts]))

        print(str(current_time) + "-->" + " Current Reactive Power from Battery: " + str(
            battery_obj.battery_react_power_actual[ts]))
        print(str(current_time) + "-->" + " Current Reactive Power from Grid: " + str(
            battery_obj.grid_react_power_actual[ts]))
        print(
            str(current_time) + "-->" + " Total Reactive Power from Load: " + str(battery_obj.load_pf * new_grid_load))
